 ...
 * @buffer: Buffer array to handle all print
 ...
 * @precision: the Precision specification
 * @size: the Size specifier
 * Return: the Numb of chars printed
 */
 ...
 * @flags:  Calculates each active flag
 * @width: getsthe width.
 ...
 * @buffer: Buffer array handles the print
 ...
 * @types: List of args
 * @buffer: Buffer array is to handle print
 * @flags:  Calculation of the active flags
 * @width: gets the width.
 * @precision: The Precision specification
 * @size: The Size specifier
 * Return: Num of character that is printed
 */
