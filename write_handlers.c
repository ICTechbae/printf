 ...
 * @is_negative: Number that is indicating num is negative
 * @ind: Index at the number that starts in the buffer
 ...
 * @ind: Index at the number starts in the buffer
 * @length: Length of number
 * @width: Width specifiers
 * @flags: Flags specifiers
 * @padd: Char representing padding
 * @extra_c: Char representing an extra char
 * @padd_start: Index at which padding should be start
 *
 * Return: Number written chars.
 */
